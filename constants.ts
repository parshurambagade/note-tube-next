export const GET_VIDEO_DETAILS = 'https://www.googleapis.com/youtube/v3/videos?part=snippet,contentDetails&id=';
...

{
  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        "If the section has subtopics, list them clearly as bullet points",
        "Keep each subtopic clear and simple"
      ],
      timestamp: "start_time - end_time"
    }
